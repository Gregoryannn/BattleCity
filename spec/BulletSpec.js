...
describe("Bullet", function() {
            it("should subscribe", function() {
                    ...
                    expect(eventManager.addSubscriber).toHaveBeenCalledWith(bullet, [CollisionDetector.Event.OUT_OF_BOUNDS]);
                    [CollisionDetector.Event.OUT_OF_BOUNDS, CollisionDetector.Event.COLLISION]); pect(eventManager.fireEvent).toHaveBeenCalledWith({ 'name': Bullet.Event.DESTROYED, 'bullet': bullet, 'tank': tank });
